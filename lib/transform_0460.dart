...
class _TransformPageViewState extends State<TransformPageView> {
  ...
  Widget build(BuildContext context) {
    List<String> images = [
      ...
      "https://raw.githubusercontent.com/DDOrozco17/Img_FlutterFlow_IOS_6J/main/ImgDiaz/BlockDibujo.png",
      "https://raw.githubusercontent.com/DDOrozco17/Img_FlutterFlow_IOS_6J/main/ImgDiaz/CuadernosArgollados.png",
      "https://raw.githubusercontent.com/DDOrozco17/Img_FlutterFlow_IOS_6J/main/ImgDiaz/LapizN2.png",
      "https://raw.githubusercontent.com/DDOrozco17/Img_FlutterFlow_IOS_6J/main/ImgDiaz/CintaEnmascarar.png"
    ];
    return Center(
      child: SizedBox(
        height: 450.0,
